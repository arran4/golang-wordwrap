...
// SetHorizontalBlockPosition sets the horizontal alignment for the entire block.
func (sw *SimpleWrapper) SetHorizontalBlockPosition(hp HorizontalBlockPosition) {
	sw.horizontalBlockPosition = hp
}

// SetVerticalBlockPosition sets the vertical alignment for the entire block.
